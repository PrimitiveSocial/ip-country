...
namespace primitivesocial\ipcountry\services;
 ...
 * @since     1.0.0
 */
class IpCountryService extends Component
{
    ...
    public function info($ip = NULL, $purpose = "location", $deep_detect = TRUE) {
